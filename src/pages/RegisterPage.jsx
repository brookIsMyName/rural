  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.card}>
        ...
        <p style={styles.subheading}>Join thousands getting better health guidance</p>
            ...
            {pwStrength && (
              <div style={{ marginTop: 6 }}>
                <div style={{ height: 3, background: "rgba(255,255,255,0.06)", borderRadius: 4, overflow: "hidden" }}>
                  <div style={{ height: "100%", width: pwStrength.width, background: pwStrength.color, borderRadius: 4, transition: "all 0.3s" }} />
                </div>
                <span style={{ fontSize: 11, color: pwStrength.color, fontFamily: "'DM Sans', sans-serif", marginTop: 3, display: "block" }}>
                  {pwStrength.label}
                </span>
              </div>
            )}
        ...
        <p style={styles.terms}>
          ...
          <span style={{ color: "#10b981", cursor: "pointer" }}>Terms of Service</span>
          {" "}and{" "}
        ...
        <p style={styles.switchText}>
          ...
          <button onClick={() => setPage("login")} style={styles.switchLink}>Sign in</button>
        </p>
      </div>
    </div>
  );
...
const styles = {
  ...
  dividerText: { color: "rgba(255,255,255,0.3)", fontFamily: "'DM Sans', sans-serif", fontSize: 13 },
  ...
  submitBtn: {
    ...
    marginTop: 4, boxShadow: "0 0 24px rgba(16,185,129,0.25)",
  },
  terms: {
    textAlign: "center", marginTop: 16,
    color: "rgba(255,255,255,0.3)", fontFamily: "'DM Sans', sans-serif", fontSize: 11, lineHeight: 1.5,
  },
  switchText: {
  ...
  switchLink: {
    ...
    color: "#10b981", fontFamily: "'DM Sans', sans-serif", fontSize: 13, fontWeight: 600,
  },
};
